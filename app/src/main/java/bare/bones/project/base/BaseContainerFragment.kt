...
import bare.bones.project.app.navigation.LocalCiceroneHolder
import bare.bones.project.app.navigation.RouterProvider
import bare.bones.project.app.navigation.SingleActivityNavigator
...
abstract class BaseContainerFragment<P : BasePresenter<V>, V : BaseView> : BaseFragment<P, V>(),
    ...
    private val navigator: Navigator by lazy {
        SingleActivityNavigator(activity, childFragmentManager, containerResId)
    }
